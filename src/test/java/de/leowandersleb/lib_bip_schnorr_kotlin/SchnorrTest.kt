...
internal class SchnorrTest {
    data class TV(
        ...
        val sig: ByteArray,
        val result: Boolean,
        val comment: String = "should succeed"
    )
...
16,,02DFF1D77F2A671C5F36183726DB2341BE58FEAE1DA2DECED843240F7B502BA659,243F6A8885A308D313198A2E03707344A4093822299F31D0082EFA98EC4E6C89,2A298DACAE57395A15D0795DDBFD1DCB564DA82B0F269BC70A74F8220429BA1DFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141,FALSE,"sig[32:64] is equal to curve order""""
                ...
                .map {
                    ...
                    TV(
                        parts[0].toInt(),
                        if (parts[1].isNotEmpty()) Schnorr.hexStringToByteArray(parts[1]) else null,
                        Schnorr.hexStringToByteArray(parts[2]),
                        Schnorr.hexStringToByteArray(parts[3]),
                        Schnorr.hexStringToByteArray(parts[4]),
                        parts[5] == "TRUE",
                        parts[6].replace("\"","")
                    )
                }
